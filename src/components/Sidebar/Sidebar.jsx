      ...
      <div ref={sidebarRef} className="sidebar_menu">
        ...
        {isUserLoggedIn && (
          <div
            ...
            className={`sidebar_menu_item ${activeIndex === 2 ? "active" : ""}`}
          >
  ...
  if (userInfo.isLoading) {
    return (
      <div className="profile_sidebar">
        <div
          className="img-placeholder shimmer"
          style={{ height: "50px", width: "50px", borderRadius: "50%" }}
        ></div>
        <div className="detail_profile">
          <div
            className="text-placeholder shimmer"
            style={{ width: "100px", height: "10px", margin: "5px 0" }}
          ></div>
          <div
            className="text-placeholder shimmer"
            style={{ width: "150px", height: "10px", margin: "5px 0" }}
          ></div>
        </div>
      </div>
    );
...
const LoginLink = () => (
  <Link to="/login" className="sidebar_menu_item sidebar_login_link">
    <div className="sidebar_menu_item_icon sidebar_login_icon">
      <LuLogIn />
    </div>
